              ...
              <div class="modal-content">
                <div class="modal-header">
                  <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    ...
                    <h4 class="modal-title">Input Data Auditor</h4>
                  </div>
                  <div class="modal-body">
                    <form action="<?=base_url('input_auditor')?>" method="POST" autocomplete="off" enctype="multipart/form-data">

                    <div class="form-group col-md-6">
                      <label for="matpel">NIK</label>
                      <input type="text" class="form-control" name="nik" placeholder="NIK Auditor"  required>
                    </div>
                    <div class="form-group col-md-6">
                      <label for="matpel">Nama</label>
                      <input type="text" class="form-control" name="nama" placeholder="Nama Auditor"  required>
                    </div>
                    <div class="form-group col-md-6">
