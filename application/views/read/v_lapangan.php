  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Assesmen Lapangan</li>
      </ol>
    </section>
    ...
    <section class="content">
      ...
      <div class="box">
        ...
        <div class="box-body">
              ...
              <tr>
                ...
                <td>
                    <?php if ($d['status']==0): ?>
                      <button class="btn btn-danger btn-sm">
                        <span class="glyphicon glyphicon-remove"></span>Belum di Nilai
                      </button>
                    <?php else: ?>
                        <?=$d['nilai']?>
                    <?php endif ?> 
                ...
                <td>
                  ...
                  <?php } else if ($this->session->userdata('level')=='Auditor'){ ?>
                    ...
                    <a href="#" class="open_modalk" id='<?=$d['id_lapangan']?>'>
                      <button class="btn btn-info btn-sm">
                        Keterangan
                      </button>
                    </a>
                    <a href="#" class="open_modals" id='<?=$d['id_lapangan']?>'>
                      <button class="btn btn-info btn-sm">
                        Nilai
                      </button>
                    </a>
           ...
           <!-- Modal Detail -->
           <div id="ModalDetailk" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
           </div>
...
<script type="text/javascript">
   $(document).ready(function () {
   $(".open_modalk").click(function(e) {
      var m = $(this).attr("id");
     $.ajax({
          url: "<?=base_url('lapangan/keterangan')?>",
          type: "GET",
          data : {id: m,},
          success: function (ajaxData){
            $("#ModalDetailk").html(ajaxData);
            $("#ModalDetailk").modal('show',{backdrop: 'true'});
           }
         });
        });
      });
